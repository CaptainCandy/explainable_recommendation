    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            for epoch in tqdm(range(FLAGS.num_epochs), ncols=80):
                ...
                if best_rmse > rmse:
                    best_rmse = rmse
                    saver.save(sess, "./checkpoints/BARER-nonshare_%s_%s.ckpt" % (dataset_name, time_str),
            ...
            np.savez("./results/criterion_%s_%s_%s.npz" % (dataset_name, time_str, "BARER-nonshare"),
