...
tf.flags.DEFINE_string("para_data", "../data2014/%s/%s.para" % (dataset_name, dataset_name), "Data parameters")
tf.flags.DEFINE_string("train_data", "../data2014/%s/%s.train" % (dataset_name, dataset_name), "Data for training")
# ==================================================
...
if __name__ == '__main__':
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            np.savez("./results/criterion_%s_%s_NARRE.npz" % (dataset_name, time_str), rmse_train=rmse_train_listforplot, rmse_test=rmse_test_listforplot,
